...
class MoveGenerationTestCase(unittest.TestCase):
    ...
    def test_can_move_in_multiple_directions(self):
        rook = Board('8/1p6/8/5P2/1p2R2P/4P3/8/1P6 w - - 0 1')._get_piece(28)
