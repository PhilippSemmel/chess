...
class ConstructionTestCase(unittest.TestCase):
    ...
    def test_capture_data_is_none(self):
        self.assertIsNone(knight1._capture_info)

    def test_capture_data_is_always_none(self):
        self.assertIsNone(knight2._capture_info)


class MoveGenerationTestCase(unittest.TestCase):
    # general
    def test_cannot_move_when_blocked_by_own_pieces(self):
        knight = Board('8/8/2P1P3/1P3P2/3N4/1P3P2/2P1P3/K7 w - - 0 1')._get_piece(27)
        self.assertEqual(set(), knight.pseudo_legal_moves)

    def test_can_make_multiple_jumps(self):
        knight = Board('K7/8/5p1P/8/6N1/4p3/5P2/8 w - - 0 1')._get_piece(30)
        self.assertEqual({(30, 45, None), (30, 36, None), (30, 20, None), (30, 15, None)}, knight.pseudo_legal_moves)
    ...
    def test_can_jump_up_right_if_square_is_empty(self):
        knight = Board('K7/8/2P5/1P3P2/3N4/1P3P2/2P1P3/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 44, None)}, knight.pseudo_legal_moves)

    def test_can_jump_up_right_if_opponent_on_square(self):
        knight = Board('K7/8/2P1p3/1P3P2/3N4/1P3P2/2P1P3/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 44, None)}, knight.pseudo_legal_moves)

    def test_can_jump_right_up_if_square_is_empty(self):
        knight = Board('K7/8/2P1P3/1P6/3N4/1P3P2/2P1P3/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 37, None)}, knight.pseudo_legal_moves)
    ...
    def test_can_jump_right_down_if_square_is_empty(self):
        knight = Board('K7/8/2P1P3/1P3P2/3N4/1P6/2P1P3/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 21, None)}, knight.pseudo_legal_moves)
    ...
    def test_can_jump_down_right_if_square_is_empty(self):
        knight = Board('K7/8/2P1P3/1P3P2/3N4/1P3P2/2P5/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 12, None)}, knight.pseudo_legal_moves)
    ...
    def test_can_jump_down_left_if_square_is_empty(self):
        knight = Board('K7/8/2P1P3/1P3P2/3N4/1P3P2/4P3/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 10, None)}, knight.pseudo_legal_moves)
    ...
    def test_can_jump_left_down_if_square_is_empty(self):
        knight = Board('K7/8/2P1P3/1P3P2/3N4/5P2/2P1P3/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 17, None)}, knight.pseudo_legal_moves)
    ...
    def test_can_jump_left_up_if_square_is_empty(self):
        knight = Board('K7/8/2P1P3/5P2/3N4/1P3P2/2P1P3/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 33, None)}, knight.pseudo_legal_moves)
    ...
    def test_can_jump_up_left_if_square_is_empty(self):
        knight = Board('K7/8/4P3/1P3P2/3N4/1P3P2/2P1P3/8 w - - 0 1')._get_piece(27)
        self.assertEqual({(27, 42, None)}, knight.pseudo_legal_moves)
    ...
    def test_cannot_jump_beyond_the_board_up_right(self):
        knight = Board('P3P3/2N5/P3P3/1P1P4/8/8/8/K7 w - - 0 1')._get_piece(50)
        self.assertEqual(set(), knight.pseudo_legal_moves)
    ...
    def test_cannot_jump_beyond_the_board_left_up(self):
        knight = Board('8/8/P1P5/3P4/1N6/3P4/P1P5/K7 w - - 0 1')._get_piece(25)
        self.assertEqual(set(), knight.pseudo_legal_moves)
    ...
    def test_cannot_jump_beyond_the_board_down_right(self):
        knight = Board('K7/8/8/8/1P1P4/P3P3/2N5/P3P3 w - - 0 1')._get_piece(10)
        self.assertEqual(set(), knight.pseudo_legal_moves)
    ...
    def test_cannot_jump_beyond_the_board_right_up(self):
        knight = Board('K7/8/5P1P/4P3/6N1/4P3/5P1P/8 w - - 0 1')._get_piece(30)
        self.assertEqual(set(), knight.pseudo_legal_moves)
