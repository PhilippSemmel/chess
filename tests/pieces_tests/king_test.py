...
class MoveGenerationTestCase(unittest.TestCase):
    ...
    def test_can_move_in_multiple_directions(self):
        ...
        self.assertEqual(
            {(35, 36, None), (35, 44, None), (35, 43, None), (35, 42, None), (35, 26, None), (35, 27, None)},
            king.pseudo_legal_moves)
    ...
    def test_can_move_one_step_right(self):
        ...
        self.assertEqual({(35, 36, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_from_any_position_right(self):
        ...
        self.assertEqual({(20, 21, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_one_step_left(self):
        ...
        self.assertEqual({(35, 34, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_from_any_position_left(self):
        ...
        self.assertEqual({(20, 19, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_one_step_up(self):
        ...
        self.assertEqual({(35, 43, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_from_any_position_up(self):
        ...
        self.assertEqual({(14, 22, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_one_step_down(self):
        ...
        self.assertEqual({(35, 27, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_from_any_position_down(self):
        ...
        self.assertEqual({(54, 46, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_one_step_right_up(self):
        ...
        self.assertEqual({(35, 44, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_from_any_position_right_up(self):
        ...
        self.assertEqual({(9, 18, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_one_step_right_down(self):
        ...
        self.assertEqual({(35, 28, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_from_any_position_right_down(self):
        ...
        self.assertEqual({(49, 42, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_one_step_left_up(self):
        ...
        self.assertEqual({(35, 42, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_from_any_position_left_up(self):
        ...
        self.assertEqual({(14, 21, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_one_step_left_down(self):
        ...
        self.assertEqual({(35, 26, None)}, king.pseudo_legal_moves)
    ...
    def test_can_move_from_any_position_left_down(self):
        ...
        self.assertEqual({(54, 45, None)}, king.pseudo_legal_moves)
    ...
    def test_can_generate_castling_moves_as_white(self):
        ...
        self.assertEqual({(4, 3, None), (4, 5, None), (4, 2, None), (4, 6, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_kingside_if_blocked_by_own_piece_as_white(self):
        ...
        self.assertEqual({(4, 3, None), (4, 5, None), (4, 2, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_kingside_if_blocked_by_own_piece_anywhere_as_white(self):
        ...
        self.assertEqual({(4, 3, None), (4, 2, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_queenside_if_blocked_by_own_piece_as_white(self):
        ...
        self.assertEqual({(4, 3, None), (4, 5, None), (4, 6, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_queenside_if_blocked_by_own_piece_anywhere_as_white(self):
        ...
        self.assertEqual({(4, 5, None), (4, 6, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_if_king_is_threatened_as_white(self):
        ...
        self.assertEqual({(4, 3, None), (4, 5, None), (4, 12, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_kingside_if_square_to_move_over_is_threatened_as_white(self):
        ...
        self.assertEqual({(4, 3, None), (4, 5, None), (4, 13, None), (4, 2, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_queenside_if_square_to_move_over_is_threatened_as_white(self):
        ...
        self.assertEqual({(4, 3, None), (4, 5, None), (4, 11, None), (4, 6, None)}, king.pseudo_legal_moves)

    # black
    def test_can_generate_castling_moves_as_black(self):
        king = Board('r3k2r/3ppp2/8/8/8/8/8/8 b kq - 0 1')._get_piece(60)
        self.assertEqual({(60, 59, None), (60, 61, None), (60, 58, None), (60, 62, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_kingside_if_blocked_by_own_piece_as_black(self):
        ...
        self.assertEqual({(60, 59, None), (60, 61, None), (60, 58, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_kingside_if_blocked_by_own_piece_anywhere_as_black(self):
        ...
        self.assertEqual({(60, 59, None), (60, 58, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_queenside_if_blocked_by_own_piece_as_black(self):
        ...
        self.assertEqual({(60, 59, None), (60, 61, None), (60, 62, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_queenside_if_blocked_by_own_piece_anywhere_as_black(self):
        ...
        self.assertEqual({(60, 61, None), (60, 62, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_if_king_is_threatened_as_black(self):
        ...
        self.assertEqual({(60, 59, None), (60, 61, None), (60, 52, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_kingside_if_square_to_move_over_is_threatened_as_black(self):
        ...
        self.assertEqual({(60, 59, None), (60, 61, None), (60, 53, None), (60, 58, None)}, king.pseudo_legal_moves)
    ...
    def test_cannot_castle_queenside_if_square_to_move_over_is_threatened_as_black(self):
        ...
        self.assertEqual({(60, 59, None), (60, 61, None), (60, 51, None), (60, 62, None)}, king.pseudo_legal_moves)
