...
class ConstructionTestCase(unittest.TestCase):
    ...
    def test_capture_data_is_none(self):
        self.assertIsNone(pawn1._capture_info)

    def test_capture_data_is_always_none(self):
        self.assertIsNone(pawn2._capture_info)
...
class MoveGenerationTestCase(unittest.TestCase):
    ...
    def test_can_move_in_multiple_directions_as_white(self):
        ...
        self.assertEqual({(19, 27, None), (19, 26, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_move_one_step_up_as_white(self):
        ...
        self.assertEqual({(10, 18, None)}, pawn.pseudo_legal_moves)

    def test_can_move_two_steps_up_on_second_row_as_white(self):
        pawn = Board('K7/8/8/2P5/8/1P1P4/2P5/8 w - - 0 1')._get_piece(10)
        self.assertEqual({(10, 18, None), (10, 26, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_move_one_step_up_anywhere_as_white(self):
        ...
        self.assertEqual({(33, 41, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_one_step_right_up_as_white(self):
        ...
        self.assertEqual({(27, 36, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_anywhere_one_step_right_up_as_white(self):
        ...
        self.assertEqual({(28, 37, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_one_step_left_up_as_white(self):
        ...
        self.assertEqual({(27, 34, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_anywhere_one_step_left_up_as_white(self):
        ...
        self.assertEqual({(28, 35, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_en_passant_left_if_available_as_white(self):
        ...
        self.assertEqual({(33, 42, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_en_passant_left_anywhere_if_available_as_white(self):
        ...
        self.assertEqual({(34, 43, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_en_passant_right_if_available_as_white(self):
        ...
        self.assertEqual({(33, 40, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_en_passant_right_anywhere_if_available_as_white(self):
        ...
        self.assertEqual({(34, 41, None)}, pawn.pseudo_legal_moves)
    ...
    # promotion
    def test_generates_all_possible_promotion_moves_after_advancing_as_white(self):
        pawn = Board('8/P7/8/8/8/8/8/K7 w - - 0 1')._get_piece(48)
        self.assertEqual({(48, 56, 'Q'), (48, 56, 'R'), (48, 56, 'N'), (48, 56, 'B')}, pawn.pseudo_legal_moves)

    def test_generates_all_possible_promotion_moves_after_capturing_as_white(self):
        pawn = Board('pp6/P7/8/8/8/8/8/K7 w - - 0 1')._get_piece(48)
        self.assertEqual({(48, 57, 'Q'), (48, 57, 'R'), (48, 57, 'N'), (48, 57, 'B')}, pawn.pseudo_legal_moves)
    ...
    def test_can_make_multiple_moves(self):
        ...
        self.assertEqual({(26, 18, None), (26, 19, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_move_one_step_down_anywhere_as_black(self):
        ...
        self.assertEqual({(43, 35, None)}, pawn.pseudo_legal_moves)
    ...
    def test_cannot_move_two_steps_down_anywhere_not_on_seventh_row_as_black(self):
        ...
        self.assertEqual({(33, 25, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_one_step_right_down_as_black(self):
        ...
        self.assertEqual({(35, 28, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_anywhere_one_step_right_down_as_black(self):
        ...
        self.assertEqual({(36, 29, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_one_step_left_down_as_black(self):
        ...
        self.assertEqual({(36, 27, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_anywhere_one_step_left_down_as_black(self):
        ...
        self.assertEqual({(35, 26, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_en_passant_left_if_available_as_black(self):
        ...
        self.assertEqual({(30, 21, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_en_passant_left_anywhere_if_available_as_black(self):
        ...
        self.assertEqual({(29, 20, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_en_passant_right_if_available_as_black(self):
        ...
        self.assertEqual({(25, 18, None)}, pawn.pseudo_legal_moves)
    ...
    def test_can_capture_en_passant_right_anywhere_if_available_as_black(self):
        ...
        self.assertEqual({(26, 19, None)}, pawn.pseudo_legal_moves)
    ...
    # promotion
    def test_generates_all_possible_promotion_moves_after_advancing_as_black(self):
        pawn = Board('k7/8/8/8/8/8/p7/8 b - - 0 1')._get_piece(8)
        self.assertEqual({(8, 0, 'q'), (8, 0, 'r'), (8, 0, 'n'), (8, 0, 'b')}, pawn.pseudo_legal_moves)

    def test_generates_all_possible_promotion_moves_after_capturing_as_black(self):
        pawn = Board('k7/8/8/8/8/8/p7/PP6 b - - 0 1')._get_piece(8)
        self.assertEqual({(8, 1, 'q'), (8, 1, 'r'), (8, 1, 'n'), (8, 1, 'b')}, pawn.pseudo_legal_moves)
